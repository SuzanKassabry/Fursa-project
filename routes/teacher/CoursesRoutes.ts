...
router.get('/get-courses-by-teacher-id', async (req, res) => {
    ...
    const query = `SELECT test_schema.courses_table.id, test_schema.courses_table.name, test_schema.classes_table.name AS class_name, test_schema.courses_table.classID AS class_id, test_schema.courses_table.teacherID AS teacher_id 
